...
Background:
  ...
  Scenario: A non-admin cannot merge articles
    ...
    Given I am on the edit page for article "test article" with id "4" written by "user"
  ...
  Scenario: A admin user merge articles 
    ...
    Then I am on the Manage articles page
    And I should see "test article"
    Given I am on the edit page for article "test article" with id "3" written by "admin"
    And I should see "Merge Articles"
    When I fill in "merge_with" with "4"
    And I press "Merge"
    Then I am on the Manage articles page
    And I should see "test article"
#    Given I am on the edit page for article "test article" written by "admin"
